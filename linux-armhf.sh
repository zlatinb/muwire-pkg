...
cp muwire-appimage-armhf.sh build/MuWire.AppDir/usr/bin/muwire-appimage.sh
...
ARCH=armhf $APPIMAGE_BINARY $APPIMAGE_OPTS build/MuWire.AppDir

echo "created Linux armhf App Image"
